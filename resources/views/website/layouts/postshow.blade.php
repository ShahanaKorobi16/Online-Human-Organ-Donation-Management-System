  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
		...
		<br>
		<br>
		<a type="button" class="btn btn-primary" href="{{route('website.donor-post.details',$adpost->id)}}"><i class="fas fa-eye"></i></a>
		
			@if(auth()->user()->id == $adpost->user_id)
			<a class="btn btn-danger" href="{{route('website.donor-post.delete',$adpost->id)}}"><i class="fas fa-trash-alt"></i></a>
			<a class="btn btn-info" href="{{route('website.donor-post.edit',$adpost->id)}}"><i class="fas fa-edit"></i></a>
			
			@else
		<a type="button" class="btn btn-dark" href="{{route('website.create-message',$adpost->id)}}"><i class="fas fa-envelope"></i></a>
		@endif
		
		<a type="button" class="btn btn-secondary" href="{{route('website.response.comment',$adpost->id)}}"><i class="fas fa-comment-dots"></i></a>
      </div>
      </div>
    </div>
  </div>
